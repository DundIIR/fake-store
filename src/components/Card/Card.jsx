...
const Card = ({ product, favorite, layout }) => {
	return (
		<>
			{layout === 'basket' ? (
					...
					<div className="card__info card__info--basket">
						...
						<div>
							...
							<div className="block-button block-button--basket">
								...
								<button className="card__btn card__btn--basket card__btn--minus"></button>
								<span className="card__count">1</span>
								<button className="card__btn card__btn--basket card__btn--plus"></button>
							</div>
						</div>
					</div>
				</div>
