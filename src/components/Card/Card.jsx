...
const Card = ({ product, favorite, layout, updateBasket = () => {} }) => {
	...
	useEffect(() => {
		updateBasket({ ...product, quantity: quantity })
	}, [quantity])
	...
	return (
		<>
			{layout === 'basket' ? (
				<div
					className={`card card--basket ${favorite ? 'favorite-active' : ''}`}
				>
					<div className='block-image block-image--basket'>
						<img
							src={product.image}
							alt={product.title}
							className='card__image card__image--basket'
						/>
					</div>
					<div className='card__info card__info--basket'>
						...
						<div>
							...
							<div className='block-button block-button--basket'>
								<button
									className='card__btn card__btn--basket card__btn--minus'
									onClick={handleDecrease}
								></button>
								<span className='card__count'>{quantity}</span>
								<button
									className='card__btn card__btn--basket card__btn--plus'
